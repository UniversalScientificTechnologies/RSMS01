...
set files [list \
 ...
 [file normalize "${origin_dir}/ext/fifo_sync_x64_96b/fifo_sync_x64_96b.xci"] \
 [file normalize "${origin_dir}/axis_serializer.v"] \
 [file normalize "${origin_dir}/registers.v"] \
 [file normalize "${origin_dir}/axis_synth_source.v"] \
 [file normalize "${origin_dir}/top_block_wrapper.v"] \
 [file normalize "${origin_dir}/ext/pgpio.v"] \
]
add_files -norecurse -fileset $obj $files

# Set 'sources_1' fileset file properties for remote files
set file "$origin_dir/ext/fifo_sync_x64_96b/fifo_sync_x64_96b.xci"
...
if { [get_files fifo_sync_x64_96b.xci] == "" } {
  import_files -quiet -fileset sources_1 /home/povik/repos/DENGS/SW/FPGA/zynq_adc_glue/ext/fifo_sync_x64_96b/fifo_sync_x64_96b.xci
}
if { [get_files axis_serializer.v] == "" } {
  import_files -quiet -fileset sources_1 /home/povik/repos/DENGS/SW/FPGA/zynq_adc_glue/axis_serializer.v
}
if { [get_files registers.v] == "" } {
  import_files -quiet -fileset sources_1 /home/povik/repos/DENGS/SW/FPGA/zynq_adc_glue/registers.v
}
if { [get_files axis_synth_source.v] == "" } {
  import_files -quiet -fileset sources_1 /home/povik/repos/DENGS/SW/FPGA/zynq_adc_glue/axis_synth_source.v
}
...
# module references:
# pi2c, synth_source_v1_0_M00_AXIS
  ...
  # Create instance: synth_source_v1_0_M0_0, and set properties
  set block_name synth_source_v1_0_M00_AXIS
  set block_cell_name synth_source_v1_0_M0_0
  if { [catch {set synth_source_v1_0_M0_0 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_msg_id "BD_TCL-105" "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $synth_source_v1_0_M0_0 eq "" } {
     catch {common::send_msg_id "BD_TCL-106" "ERROR" "Unable to referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   }
  ...
  connect_bd_intf_net -intf_net ps7_0_axi_periph_M01_AXI [get_bd_intf_pins ps7_0_axi_periph/M01_AXI] [get_bd_intf_pins synth_source_v1_0_M0_0/S_AXI]
  connect_bd_intf_net -intf_net synth_source_v1_0_M0_0_M_AXIS [get_bd_intf_pins axi_dma_0/S_AXIS_S2MM] [get_bd_intf_pins synth_source_v1_0_M0_0/M_AXIS]

  # Create port connections
  connect_bd_net -net Net2 [get_bd_ports i2c_sda] [get_bd_pins pi2c_0/i2c_sda]
  connect_bd_net -net Net3 [get_bd_ports i2c_scl] [get_bd_pins pi2c_0/i2c_scl]
  connect_bd_net -net adc_d_n_1 [get_bd_ports adc_d_n] [get_bd_pins synth_source_v1_0_M0_0/adc_d_n]
  connect_bd_net -net adc_d_p_1 [get_bd_ports adc_d_p] [get_bd_pins synth_source_v1_0_M0_0/adc_d_p]
  connect_bd_net -net adc_dclk_n_1 [get_bd_ports adc_dclk_n] [get_bd_pins synth_source_v1_0_M0_0/adc_dclk_n]
  connect_bd_net -net adc_dclk_p_1 [get_bd_ports adc_dclk_p] [get_bd_pins synth_source_v1_0_M0_0/adc_dclk_p]
  connect_bd_net -net adc_fclk_n_1 [get_bd_ports adc_fclk_n] [get_bd_pins synth_source_v1_0_M0_0/adc_fclk_n]
  connect_bd_net -net adc_fclk_p_1 [get_bd_ports adc_fclk_p] [get_bd_pins synth_source_v1_0_M0_0/adc_fclk_p]
  ...
  connect_bd_net -net rst_ps7_0_100M_peripheral_aresetn [get_bd_pins axi_dma_0/axi_resetn] [get_bd_pins axi_smc/aresetn] [get_bd_pins ps7_0_axi_periph/M00_ARESETN] [get_bd_pins ps7_0_axi_periph/M01_ARESETN] [get_bd_pins ps7_0_axi_periph/S00_ARESETN] [get_bd_pins rst_ps7_0_100M/peripheral_aresetn] [get_bd_pins synth_source_v1_0_M0_0/resetn]
  ...
  create_bd_addr_seg -range 0x00001000 -offset 0x60000000 [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs axi_dma_0/S_AXI_LITE/Reg] SEG_axi_dma_0_Reg
  create_bd_addr_seg -range 0x00001000 -offset 0x60001000 [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs synth_source_v1_0_M0_0/S_AXI/reg0] SEG_synth_source_v1_0_M0_0_reg0
