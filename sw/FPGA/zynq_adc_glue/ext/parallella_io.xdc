...
set_property IOSTANDARD LVDS_25 [get_ports adc*]

set_property PACKAGE_PIN U18 [get_ports adc_dclk_n]
set_property PACKAGE_PIN U19 [get_ports adc_dclk_p]
set_property PACKAGE_PIN U14 [get_ports adc_fclk_p]
set_property PACKAGE_PIN U15 [get_ports adc_fclk_n]

set_property PACKAGE_PIN T14 [get_ports {adc_d_n[0]}]
set_property PACKAGE_PIN T15 [get_ports {adc_d_p[0]}]
set_property PACKAGE_PIN W14 [get_ports {adc_d_n[1]}]
set_property PACKAGE_PIN Y14 [get_ports {adc_d_p[1]}]
set_property PACKAGE_PIN V12 [get_ports {adc_d_n[2]}]
set_property PACKAGE_PIN W13 [get_ports {adc_d_p[2]}]
set_property PACKAGE_PIN T11 [get_ports {adc_d_n[3]}]
set_property PACKAGE_PIN T10 [get_ports {adc_d_p[3]}]
set_property PACKAGE_PIN T12 [get_ports {adc_d_p[4]}]
set_property PACKAGE_PIN U12 [get_ports {adc_d_n[4]}]
set_property PACKAGE_PIN P14 [get_ports {adc_d_p[5]}]
set_property PACKAGE_PIN R14 [get_ports {adc_d_n[5]}]
set_property PACKAGE_PIN P15 [get_ports {adc_d_p[6]}]
set_property PACKAGE_PIN P16 [get_ports {adc_d_n[6]}]
